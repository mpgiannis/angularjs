...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
        ...
        $("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-text'>"+this.p.loadtext+"</div></div>").insertBefore(gv);
