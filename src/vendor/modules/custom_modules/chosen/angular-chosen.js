            ...
            return {
                ...
                link: function(scope, element, attr, ngModel) {
                    ...
                    element.on('chosen:showing_dropdown', function() {
                        ...
                        let chosenContainer = element.siblings('.chosen-container');
                        
                        let windowHeight = $(window).height();
                        let offsetInWindow = chosenContainer.offset().top - $(window).scrollTop();
                        
                        let percentage = (100 * offsetInWindow) / windowHeight;
                        
                        if(percentage > 65) {
                            chosenContainer.addClass('chosen-container-dropup');
                        }
                        else {
                            chosenContainer.removeClass('chosen-container-dropup');
                        }
                    });
